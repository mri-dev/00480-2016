<?php
/**
* 2017/01/27-es javítási kérés verziója
*
* @version v2
* @since 2017-01-27
**/
  ...
  <div class="search-wrapper">
    <form id="modul-page-searcher-form-v1" action="/<?=KERESO_SLUG?>" method="get">
      <div class="head-labels">
        <ul>
          <li class="main"><input type="radio" <?=($_GET['cat'] == '')?'checked="checked"':''?> name="cat" id="cat_all" value=""><label class="trans-on" for="cat_all">Utazási ajánlatok</label></li><!--
